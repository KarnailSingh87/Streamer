...
const es: Partial<Dict> = {
  ...
  errPlayback: 'Reproducción fallida — el servidor no pudo reproducir este título.',
...
const de: Partial<Dict> = {
  ...
  errPlayback: 'Wiedergabe fehlgeschlagen — der Server konnte diesen Titel nicht abspielen.',
...
const pt: Partial<Dict> = {
  ...
  errPlayback: 'Reprodução falhou — o servidor não conseguiu reproduzir este título.',
...
const ko: Partial<Dict> = {
  ...
  errPlayback: '재생 실패 — 서버가 이 타이틀을 재생할 수 없습니다.',
